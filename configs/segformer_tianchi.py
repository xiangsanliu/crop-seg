...
config = dict(
    ...
    train_pipeline = dict(
        train_loader = dict(batch_size = 16,num_workers = 12,drop_last = True,pin_memory=True,shuffle=True),
        val_loader = dict(batch_size = 16,num_workers = 12,drop_last = True,pin_memory=False,shuffle=False),
